...
const contents = [
    {
        ...
        body: `
            ...
            <p>
            Let's start creating a project with <code>npx create-react-app myproject</code>, or <code>yarn create myproject</code>. Now navigate to the page with <code> cd /myproject</code> and then start the development server with <code>npm start</code> or <code>yarn start</code>. Then you can open your localhost server and see the boilerplate react app.
            </p>
        `,
    },
    {
